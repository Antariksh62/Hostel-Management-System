...
exports.submitFeedback = async (req, res) => {
    try {
        ...
        const isResolvedValue = req.body.isResolved === "true" || req.body.isResolved === true;
        const ratingValue = req.body.rating ? parseInt(req.body.rating) : 5;
        ...
        // If the student says it's not resolved, reopen the complaint
        if (!isResolvedValue) {
